...
from bim_gw.utils.utils import (
    get_job_detailed_slug_from_coefficients, get_job_slug_from_coefficients,
    get_runs_dataframe
)
from bim_gw.utils.visualization import (
    get_agg_args_from_dict, sem_fn,
    set_new_cols
)
...
if __name__ == '__main__':
    ...
    for figure in vis_args.figures:
        ...
        plt.savefig(
            ...
            ) / f"{now}_coefs.pdf", bbox_inches="tight"
        )
        plt.show()
