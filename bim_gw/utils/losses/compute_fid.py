...
def compute_dataset_statistics(
    dataset, stats_path, dataset_name, batch_size, device
):
    """
    ...
    Args:
        ...
        dataset_name: name of the dataset. The stat file will be
        `inception_stats_{dataset_name}.npy`
        batch_size:
        device:
    """
...
def compute_FID(
    ...
    # stats_path = os.path.join(args.dataset_root, args.dataset,
    ...
    fid_value = calculate_frechet_distance(
        mu_dataset, sigma_dataset, mu_model, sigma_model
    )
