...
def train_lm(args):
    ...
    if "checkpoint" in args and args.checkpoint is not None:
        checkpoint_path = get_checkpoint_path(args.checkpoint)
        optimize_attr_regression = args.lm.optimize_vae_with_attr_regression
        ...
        lm = SimpleShapesText.load_from_checkpoint(
            ...
            optimize_vae_with_attr_regression=optimize_attr_regression,
...
def train_vae(args):
    ...
    if "checkpoint" in args and args.checkpoint is not None:
        ...
        vae = VAE(
            ...
            args.vae.optim.lr,
            args.vae.optim.weight_decay,
            args.vae.scheduler.step,
